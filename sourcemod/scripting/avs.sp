 ...
 * provided standalone web interface.
 * 
 * AVS is a FORK project based on "AdsQL" and "MySQL Advertisements"
 * This plugin has been updated, and modifed for work with Dr. McKay's "MoreColors".
 * 
 * New webpanel designed by SkyWalker from CTSGaming.com
 * Plugin updated by SkyWalker from CTSGaming.com and tested with the help of Degree-Gaming.com
 * =============================================================================
...
public ParseAds(Handle:owner, Handle:hQuery, const String:error[], any:client)
{
	...
	if (hQuery != INVALID_HANDLE)
	{
		...
		if (client > 0)
			CPrintToChat(client, "[AdsQL] Reloaded Ads");
	}
	else
	{
